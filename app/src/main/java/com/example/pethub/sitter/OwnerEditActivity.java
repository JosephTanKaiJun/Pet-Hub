...
public class OwnerEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load owner details into editable fields
        loadOwnerDetails();
    ...
    private void loadOwnerDetails() {
        ...
        if (cursor.moveToFirst()) {
            ...
            if (nameIndex < 0 || studentIdIndex < 0 || emailIndex < 0 || phoneIndex < 0 || bioIndex < 0 ||
                    carePetsIndex < 0 || carePlantsIndex < 0) {
    ...
    private void saveChanges() {
        ...
        // Update database
        try {
            dbHelper.updateOwnerDetails(userId, name, studentId, email, phone, bio, carePets, carePlants);
            setResult(RESULT_OK);
            finish();
        } catch (Exception e) {
